...
// Define or import your FormSchema type here
// Example definition (replace with your actual schema if different)
      ...
      render={({ field, fieldState }) => (
        <FormItem>
          ...
          <div className="space-y-2">
            <div className="relative">
              <FormControl>
                <Input
                  ...
                  {...field}
                  aria-invalid={
                    fieldState.isTouched ? strengthScore < 4 : undefined
                  }
            ...
            {/* Password requirements list */}
            <ul
              className="grid grid-cols-2 gap-y-1.5 gap-x-4"
